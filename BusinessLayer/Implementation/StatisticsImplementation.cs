        ...
        internal async Task<StatisticsResponse> StatisticsAction(string id)
        {
            ...
            using (var context = new SFBDContext())
            {
                if (id != "0")
                {
                    ...
                    && DateTime.Now.Year - e.BirthDate.Value.Year <= 40
                    && e.Region.ToString() == id).Count().ToString();
                    agesList.Add(age26);
                    ...
                    && DateTime.Now.Year - e.BirthDate.Value.Year <= 50
                    && e.Region.ToString() == id).Count().ToString();
                    agesList.Add(age41);
                    ...
                    && DateTime.Now.Year - e.BirthDate.Value.Year <= 65
                    && e.Region.ToString() == id).Count().ToString();
                    agesList.Add(age51);
                ...
                else
                {
                    ...
                    age18.Voters = context.IdvnAccounts.Where(e => DateTime.Now.Year - e.BirthDate.Value.Year >= 18
                    && DateTime.Now.Year - e.BirthDate.Value.Year <= 25).Count().ToString();
                    agesList.Add(age18);
                    ...
                    age26.Voters = context.IdvnAccounts.Where(e => DateTime.Now.Year - e.BirthDate.Value.Year >= 26
                    && DateTime.Now.Year - e.BirthDate.Value.Year <= 40).Count().ToString();
                    agesList.Add(age26);
                    ...
                    age41.Voters = context.IdvnAccounts.Where(e => DateTime.Now.Year - e.BirthDate.Value.Year >= 41
                    && DateTime.Now.Year - e.BirthDate.Value.Year <= 50).Count().ToString();
                    agesList.Add(age41);
                    ...
                    age51.Voters = context.IdvnAccounts.Where(e => DateTime.Now.Year - e.BirthDate.Value.Year >= 51
                    && DateTime.Now.Year - e.BirthDate.Value.Year <= 65).Count().ToString();
                    agesList.Add(age51);
